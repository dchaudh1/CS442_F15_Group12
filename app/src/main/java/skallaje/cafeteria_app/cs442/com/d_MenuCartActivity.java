    ...
    private void populateList() {
        ...
        if (result.moveToFirst()) {
            do {
                ...
                total = totaltmp.substring(0, totaltmp.indexOf('.') + 2);
                Log.i("Total:", total);
        ...
        finalPrice.put(FOURTH_COLUMN, "$" + Double.toString(global_finalTotal));
        list.add(finalPrice);
    }

    public void confirmOrder(View view) {
        if (global_finalTotal > 0) {
            ...
            Toast.makeText(d_MenuCartActivity.this, "Your cart is empty!", Toast.LENGTH_LONG).show();
